...
import MpARPProduct from '../../../componets/MpARProduct'
...
const ProductFullDetail = props => {
    ...
    return (
        <Fragment>
            {breadcrumbs}
            <MpARPProduct location={Constants.LOCATION_ABOVE_CONTENT} arpProduct={arpProductProps} />
            ...
            <MpARPProduct location={Constants.LOCATION_BELOW_CONTENT} arpProduct={arpProductProps} />
            <MpARPProduct location={Constants.LOCATION_LEFT_POPUP_CONTENT} arpProduct={arpProductProps} />
            <MpARPProduct location={Constants.LOCATION_RIGHT_POPUP_CONTENT} arpProduct={arpProductProps} />
        </Fragment>
    );
};
